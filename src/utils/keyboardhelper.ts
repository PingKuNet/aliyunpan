...
const menulist = ['leftpansubmove', 'leftpansubzhankai', 'leftpanmenu', 'rightpansubmove', 'rightpansubbiaoji','rightpansubmore', 'rightpanmenu', 'rightpantrashmenu', 'rightmysharemenu', 'rightothersharemenu','rightuploadingmenu', 'rightuploadedmenu', 'ightdowningrmenu', 'rightdownedmenu']
